  ...
  <div class="main-container">
    <div class="card">
      <el-menu
        ...
        <el-menu-item index="following">{{ isCurrentUser ? $t('followingTabTitle') : $t('followingTabTitleOther') }}</el-menu-item>
        <el-menu-item index="follower">{{ isCurrentUser ? $t('followerTabTitle') : $t('followerTabTitleOther') }}</el-menu-item>
      </el-menu>
      <my-loader
        :loading="loading"
        :error="error"
        :on-reload="getUsers"/>
      <my-empty v-if="!loading && !users.length" />
...
export default {
  ...
  methods: {
    getUsers () {
      ...
      fn(this.pageUID, this.currentPage).then(({
